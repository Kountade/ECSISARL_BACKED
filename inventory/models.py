...
class InventoryCountItem(models.Model):
    ...
    product = models.ForeignKey(Product, on_delete=models.PROTECT)
    variant = models.ForeignKey(  # ✅ Ce champ existe bien
        ProductVariant, on_delete=models.SET_NULL,
        null=True, blank=True
    )
    ...
    class Meta:
        # ✅ Correction : 'variant' existe bien, mais si vous voulez sans variant
        # Vous pouvez remplacer par ['inventory', 'product'] si vous ne voulez pas de variant
